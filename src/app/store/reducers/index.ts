...
export const getFilms = createSelector(getFilmState, fromFilms.getFilms);

export const getSelected = createSelector(getFilmState, fromFilms.getSelected);
...
export const getIds = createSelector(getFilmState, fromFilms.getIds);
...
export const getRate = createSelector(getFilmState, fromFilms.getRate);